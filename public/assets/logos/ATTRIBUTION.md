...
Third-party logos are used only to identify companies and clients mentioned in the professional portfolio.

- `bbva.svg`: BBVA logo from Wikimedia Commons.
- `vueling.svg`: Vueling logo from Wikimedia Commons.
- `iberostar.jpg`: Iberostar logo image from Wikimedia Commons.
